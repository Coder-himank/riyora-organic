...
const ProductPage = ({ productId, productData }) => {
  ...
  const [productSchema, setProductSchema] = useState({
    ...
    image: [`${site_url}${productData.imageUrl[0]}`],
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content={`${site_url}${productData.imageUrl[0]}`}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({ ...productSchema, inLanguage: "en" }),
          }}
        />
      </Head>
            ...
            <section className={styles.sec_1}>
              ...
              <div className={styles.details}>
                ...
                <div className={styles.description}>
                  <p>
                    {productData.description ||
                      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorem, vel a. Deleniti molestiae vitae temporibus deserunt dolor expedita accusantium cupiditate odit. Commodi sed quia modi, sequi ullam officia beatae voluptate!"}
                  </p>
                </div>
                ...
                <div className={styles.quick_links}>
                  <ul>
                    <li>
                      <Link href={"/"}>Check Suitability</Link>
                    </li>
                    <li>
                ...
                <div className={styles.price_quantity}>
                  ...
                  <div className={styles.quantity}>
                    <button
                      onClick={() =>
                        setQuantityDemanded((q) => (q - 1 !== 0 ? q - 1 : 1))
                      }
                    >
                      -
                    </button>
                    ...
                    <button
                      onClick={() => setQuantityDemanded(quantity_demanded + 1)}
                    >
                      +
                    </button>
                  </div>
                ...
                <div className={styles.action_btn}>
                  ...
                  <button
                    onClick={() =>
                      onBuy(router, productId, quantity_demanded, session)
                    }
                  >
                    Buy Now
                  </button>
                      ...
                      {Array.from({ length: 6 }).map((_, index) => (
                        <>
                          <div className={styles.suitable_images} key={index}>
                            <Image
                              src={`/images/suitable_${index + 1}.png`}
                              width={300}
                              height={300}
                              alt="Image"
                            />
                  ...
                  <div className={styles.apply_box} key={index}>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        Minus reprehenderit corrupti alias eos quo.
                      </p>
                    </div>
                  </div>
                ))}
