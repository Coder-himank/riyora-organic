    ...
    <div className={style.container}>
      <div className={style.header}>
        ...
        <p className={style.text}>
          Welcome to Riyora Organic. We respect your privacy and are committed to
      ...
      <div className={style.policies}>
        ...
        <section>
          ...
          <p className={style.text}>
            ...
            you register on the site, place an order, or contact us. This includes:
          </p>
        ...
        <section>
          ...
          <p className={style.text}>
            All payments on our website are processed securely through Razorpay.
        ...
        <section>
          ...
          <p className={style.text}>
            We use cookies to store user credentials and enhance your browsing
            experience. These may also be used for analytics and personalized
            advertising.
          </p>
        </section>
        ...
        <section>
          ...
          <p className={style.text}>
            We use Google Analytics and Facebook Pixel to monitor website
            performance and user interaction. These tools may collect anonymized
            data such as device information, IP address, browser type, and site
            activity.
          </p>
        </section>
        ...
        <section>
          ...
          <p className={style.text}>
            By using our site and submitting your information, you consent to the
            collection and use of your personal data as outlined in this policy.
            Marketing messages are only sent to users who have explicitly opted in.
          </p>
        </section>
        <section>
          ...
          <p className={style.text}>
            Our website is not intended for users under the age of 16. We do not
            knowingly collect or store personal information from children.
          </p>
        </section>
        ...
        <section>
          ...
          <p className={style.text}>
            ...
            information. You may also opt out of receiving promotional emails at any
            time.
          </p>
        </section>
